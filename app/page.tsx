...
・主体的にプロジェクトをドライブできる方`,
  ...
  {
    label: "開発・エンジニア",
    dataJd: `【職種】システム開発・エンジニア
【ミッション】開発プロジェクトの品質・納期・コストの最適化
【業務内容】
・開発進捗・品質データの分析と課題特定
・リソース配分の見直しと優先度判断
・障害・遅延発生時の原因分析と対応策立案
...
【ミッション】採用・定着・組織健全性の数値改善
【業務内容】
・採用数・定着率・エンゲージメントデータの分析
・問題部門・問題指標の特定と施策立案
・経営層への人事データに基づく提言
【求める人物像】
・人事データから組織課題を読み取れる方
...
・データと感覚の両方で判断できる方`,
  ...
  {
    label: "エージェント",
    dataJd: `【職種】人材エージェント（キャリアアドバイザー／RA）
【ミッション】担当求人の充足率・内定承諾率・売上目標の達成
【業務内容】
・求人別・担当者別の進捗データ分析
・ボトルネック（書類通過率・内定率・承諾率）の特定
・数字を踏まえた優先行動の見直し
【求める人物像】
...
・企業・候補者双方にとって誠実な判断ができる方`,
  ...
  },
  {
    label: "コンサル",
    dataJd: `【職種】経営コンサルタント
【ミッション】クライアント企業のKPI改善と施策の費用対効果の最大化
【業務内容】
・クライアントの経営データ・業績指標の分析
・問題領域の特定と改善優先度の整理
・数値根拠に基づく提言レポートの作成
【求める人物像】
