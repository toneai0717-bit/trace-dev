...
【業務内容】
・担当顧客20社への定期訪問・提案活動
・新規顧客の開拓（月3〜5件のアポ獲得が目標）
・月次・四半期の売上数字管理と上司への報告
・商談進捗の管理（パイプライン管理）
【具体的な数字感】
・月間売上目標：800万円、現在達成率：72%
・担当顧客のうち、更新時期を迎える顧客：3社
・新規商談数：今月5件中2件が停滞中
【求める人物像】
...
【業務内容】
・主要サプライヤー15社との価格・納期・品質交渉
・調達データの月次分析とコスト削減施策の立案・報告
・リスク管理と代替調達先の確保・開拓
・社内製造・生産部門との需要調整と調達計画の策定
【具体的な数字感】
・年間調達総額：約12億円、削減目標：3%（約3,600万円）
・主要部品の納期遵守率：87%（目標95%）
・単一サプライヤー依存品目：全体の23%（リスク品目）
【求める人物像】
・データを読んで問題の本質を特定できる方
...
【業務内容】
・SNS・リスティング・展示会など施策別の効果測定とデータ分析
・月次・四半期の予算配分見直しと上長への改善提案
・KPI（リード数・CVR・CPAなど）の進捗管理と次期計画への反映
・競合動向の調査と市場トレンドの把握
【具体的な数字感】
・上半期マーケ予算：2,400万円（SNS広告・リスティング・イベントに配分）
・目標リード数：月200件、現在達成率：68%（月136件）
・チャネル別CPA：SNS広告18,000円、リスティング11,000円、イベント42,000円
【求める人物像】
...
・障害・遅延発生時の原因分析と対応策立案
【具体的な数字感】
・担当プロジェクト：3つ並行（主担当1、支援2）
・直近スプリント完了率：計画対比78%（目標90%）
・本番障害：今月2件（うち1件は軽微、1件は3時間の影響）
・リリース予定まで：残6週間、未着手タスク：全体の35%
【求める人物像】
・数字とログから問題を素早く特定できる方
...
【具体的な数字感】
・今期採用目標：25名、現在内定承諾：14名（残11名、期末まで3ヶ月）
・入社3ヶ月以内の早期離職率：18%（業界平均12%、昨年比+4%）
・エンゲージメントスコア：62点（目標70点）、特に営業部門が低い
・採用単価：平均98万円（目標80万円以内）
【求める人物像】
・人事データから組織課題を読み取れる方
・数字の背景にある人の動きを想像できる方
...
【具体的な数字感】
・月間売上目標：420万円、現在達成：280万円（達成率67%、残15営業日）
・担当求人：12件（充足済み2件、進行中8件、新規開拓中2件）
・内定承諾待ち候補者：3名（承諾期限：それぞれ明日・3日後・来週）
・書類選考中の候補者：企業からの結果待ち8名（最長10日間回答なしの企業あり）
【求める人物像】
...
【具体的な数字感】
・担当クライアント：製造業（売上150億円規模）のコスト構造改善PJ
・粗利率：現在18%、業界平均24%（6ポイントの乖離が課題）
・コスト内訳：材料費52%、人件費21%、物流費15%、その他12%
・PJ期間：残8週間、中間報告まで2週間
【求める人物像】
